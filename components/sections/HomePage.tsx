    ...
    return (
        <PageRevealEffects>
            ...
            <div id="gem-hero" className="antialiased text-white bg-[#020617] font-sans relative flex flex-col selection:bg-[#3F8BF9] selection:text-white overflow-x-clip">
                ...
                <section id="home-hero" className="relative min-h-screen bg-[#020617] overflow-hidden scroll-mt-20 md:scroll-mt-24 flex items-center">
                        ...
                        <div className="minor-services-col">
                            <div className="minor-services-inner">
                                ...
                                <div className="minor-group" id="group-seo">
                                    ...
                                    <Link href="/retargeting-campaigns" className="minor-card-link">
                                        <div className="minor-card">
                                            <div className="icon-box">
                ...
                <section id="different" className="relative z-10 w-full bg-[#050b21] overflow-hidden py-16 md:py-20 scroll-mt-20 md:scroll-mt-24">
                    ...
                    <div className="max-w-[1400px] mx-auto px-6 md:px-12 relative z-10">
                            ...
                            <div className="fade-in-right bento-card bento-performance md:col-span-1 md:row-span-2 p-8 hover-target flex flex-col min-h-[300px] bg-white border border-slate-200 rounded-2xl shadow-[0_8px_30px_rgba(0,0,0,0.08)] hover:shadow-[0_20px_40px_rgba(0,0,0,0.12)] transition-all duration-300 hover:-translate-y-1" style={{ animationDelay: "0.2s" }}>
                                <div className="bento-content flex-1 flex flex-col relative z-20 min-h-0">
                                    ...
                                    <div className="bento-chart-area relative w-full mt-6 flex flex-col justify-end">
                                        ...
                                        <svg viewBox="0 0 100 50" className="w-full h-[120px] max-h-[120px] pointer-events-none mt-auto drop-shadow-[0_5px_5px_rgba(63,139,249,0.2)] relative z-20 overflow-visible">
                                            <defs>
                                            ...
                                            <path d="M0,42 Q10,34 20,38 T40,24 T60,28 T80,10 T100,14 L100,50 L0,50 Z" fill="url(#fillGrad)" opacity="0.5">
                                                <animate attributeName="opacity" values="0.3;0.7;0.3" dur="4s" repeatCount="indefinite" />
                                            </path>
                                            <path id="sparkline-path" d="M0,42 Q10,34 20,38 T40,24 T60,28 T80,10 T100,14" pathLength="100" fill="none" stroke="url(#lineGrad)" strokeWidth="2.5" strokeLinecap="round" className="animate-sparkline" />
                        ...
                        <div className="scale-in max-w-4xl mx-auto relative hover-target z-10" style={{ animationDelay: "0.3s" }}>
                        ...
                        <div className="fade-in-up w-full z-20 mx-auto" style={{ animationDelay: "0.1s" }}>
                            <div id="contact-cta-master-box" className="relative z-10 w-full">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 items-stretch w-full">
                                    ...
                                    <div className="relative rounded-2xl p-6 sm:p-8 md:p-9 bg-[#0b1330]/80 border border-[#7469F8]/25 flex flex-col items-center text-center justify-between shadow-[0_10px_30px_rgba(0,0,0,0.25)]">
                                        <div className="flex-1 flex flex-col items-center text-center w-full">
                                            <div className="w-12 h-12 rounded-xl bg-[#7469F8]/10 border border-[#7469F8]/30 flex items-center justify-center text-[#7469F8] mb-5 flex-shrink-0 mx-auto">
                                    ...
                                    <div className="relative rounded-2xl p-6 sm:p-8 md:p-9 bg-[#0b1330]/80 border border-[#3F8BF9]/30 flex flex-col items-center text-center justify-between shadow-[0_10px_30px_rgba(0,0,0,0.25)]">
                                        <div className="flex-1 flex flex-col items-center text-center w-full">
                                            <div className="w-12 h-12 rounded-xl bg-[#3F8BF9]/10 border border-[#3F8BF9]/30 flex items-center justify-center text-[#3F8BF9] mb-5 flex-shrink-0 mx-auto">
                                        ...
                                        <div className="w-full flex justify-center pt-2">
                                            <a
                                                ...
                                                className="group inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-full font-bold text-base text-white bg-gradient-to-r from-[#3F8BF9] via-[#7469F8] to-[#AB57F3] shadow-[0_0_20px_rgba(63,139,249,0.3)] hover:shadow-[0_0_35px_rgba(171,87,243,0.5)] hover:-translate-y-0.5 transition-all no-underline border border-[#3F8BF9]/30 min-w-[260px] text-center"
                                            >
