...
export default function NewsAndEventsPage() {
  ...
  const handleCardClick = (event: UpcomingEvent, e: React.MouseEvent) => {
    // Only open modal if the user didn't perform a significant drag
  ...
  return (
    <div className="relative min-h-screen bg-[#020617] text-white selection:bg-[#3F8BF9] selection:text-white overflow-x-clip">
      ...
      <div className="relative z-10 mx-auto max-w-[1400px] px-5 sm:px-8 md:px-12 pt-28 sm:pt-32 md:pt-36 pb-24">
        ...
        {/* 1. HERO SECTION                                                           */}
        {/* ========================================================================= */}
        <header className="mb-10 sm:mb-12 md:mb-14 max-w-3xl">
        ...
        {/* ========================================================================= */}
        {/* 2. UPCOMING EVENTS HORIZONTAL CAROUSEL                                    */}
        {/* ========================================================================= */}
        <section 
        ...
        {/* ========================================================================= */}
        {/* 3. LATEST NEWS & INSIGHTS (Vertical 3-Column Grid)                        */}
        {/* ========================================================================= */}
        <section aria-label="Latest News and Insights">
        ...
        {/* ========================================================================= */}
        {/* 4. EVENT PARTNERSHIP CTA BANNER                                           */}
        {/* ========================================================================= */}
        <div className="relative mt-16 sm:mt-20 md:mt-24 rounded-2xl p-8 sm:p-10 text-center bg-[#0b1330]/80 border border-[#7469F8]/25 shadow-[0_15px_40px_rgba(0,0,0,0.3)]">
          <div className="max-w-xl mx-auto">
            <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-white tracking-tight mb-2.5">
              Want to meet us at an upcoming event?
            </h3>
            
            <p className="text-slate-300 text-xs sm:text-sm font-light leading-relaxed mb-6">
              Our leadership team and performance strategists attend premier conferences globally. Schedule a dedicated 1-on-1 strategy meeting with our executives.
            </p>

            <button
              type="button"
              className="open-contact-modal inline-flex items-center justify-center gap-2 px-7 py-3 rounded-full font-bold text-sm text-white bg-gradient-to-r from-[#3F8BF9] via-[#7469F8] to-[#AB57F3] shadow-[0_0_20px_rgba(63,139,249,0.3)] hover:shadow-[0_0_35px_rgba(171,87,243,0.5)] hover:-translate-y-0.5 transition-all duration-300 cursor-pointer border border-[#3F8BF9]/30"
            >
      ...
      {/* ========================================================================= */}
      {/* 5. SEPARATE EVENT DETAILS POPUP MODAL                                     */}
      {/* ========================================================================= */}
      {selectedEvent && (
        <div
              ...
              <div className="md:col-span-6 flex flex-col justify-between">
                ...
                <div className="pt-4 border-t border-white/10 flex flex-col sm:flex-row gap-3">
                  ...
                  <button
                    ...
                    onClick={() => {
                      setSelectedEvent(null);
                      // Trigger contact modal if present
                      const contactBtn = document.querySelector<HTMLButtonElement>(".open-contact-modal");
